...
cp /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak /data/data/com.termux/files/usr/bin/groot3.sh
cp /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak /data/data/com.termux/files/usr/bin/groot4.sh
...
cp /data/data/com.termux/files/usr/bin/groot1.sh /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak
cp /data/data/com.termux/files/usr/bin/groot2.sh /sdcard/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak
am start -n com.tencent.ig/com.epicgames.ue4.SplashActivity
chmod 000 /data/data/com.tencent.ig/files/tss_tmp/* &> /dev/null
am start -n com.tencent.ig/com.epicgames.ue4.SplashActivity &> /dev/null && sleep 
echo -e "\e[36m [bypassig offline ban..........]" && sleep 1 && clear && sleep 10 && echo ""
echo -e "\e[36m [started pubg gl]" && sleep 5 && clear
...
echo " "
sleep 15
echo " Bypassed Sucessfully Looping..........."
echo " "
...
am start -n com.termux/com.termux.app.TermuxActivity &> /dev/null 
clear & echo " Game Closed, Stopping......" && sleep 5
clear
clear & echo " Done......" 
exit 0
...
am start -n com.termux/com.termux.app.TermuxActivity &> /dev/null 
echo -e "\e[36m [Starting pubg]" && sleep 2 && echo "" && clear && echo -e "\e[36m [Started pubg]"
cp /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak /data/data/com.termux/files/usr/bin/groot3.sh
cp /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak /data/data/com.termux/files/usr/bin/groot4.sh
...
cp /data/data/com.termux/files/usr/bin/groot1.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak
cp /data/data/com.termux/files/usr/bin/groot2.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak
am start -n com.rekoo.pubgm/com.epicgames.ue4.SplashActivity
chmod 000 /data/data/com.rekoo.pubgm/files/tss_tmp/* &> /dev/null
am start -n com.rekoo.pubgm/com.epicgames.ue4.SplashActivity &> /dev/null && sleep 
echo -e "\e[36m [bypassig offline ban..........]" && sleep 1 && clear && sleep 10 && echo ""
echo -e "\e[36m [started pubg tw]" && sleep 5 && clear
echo -e "\e[36m [starting cleaner]" && sleep 1
echo -e "\e[31m   Press CTRL+C to stop!"      
i=1
j=0
...
while [ $(pidof $PACKAGE) ]
do
rm -rf /data/data/com.rekoo.pubgm/app_bugly 2> /dev/null
rm -rf /data/data/com.rekoo.pubgm/cache 2> /dev/null
rm -rf /data/data/com.rekoo.pubgm/code_cache 2> /dev/null
rm -rf /storage/emulated/0/Android/data/com.rekoo.pubgm/cache 2> /dev/null
rm -rf /storage/emulated/0/Android/data/com.rekoo.pubgm/files/tbslog 2> /dev/null
rm -rf /storage/emulated/0/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs 2> /dev/null
rm -rf /storage/emulated/0/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/StatEventReportedFlag 2> /dev/null
cp /data/data/com.termux/files/usr/bin/groot1.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak
cp /data/data/com.termux/files/usr/bin/groot2.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak
...
rm -r /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak > /dev/null 2>&1
rm -r /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak > /dev/null 2>&1
cp /data/data/com.termux/files/usr/bin/groot3.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11800.pak
cp /data/data/com.termux/files/usr/bin/groot4.sh /sdcard/Android/data/com.rekoo.pubgm/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/game_patch_0.17.0.11801.pak
am start -n com.termux/com.termux.app.TermuxActivity &> /dev/null 
clear & echo " Game Closed, Stopping......" && sleep 5
clear
clear & echo " Done......" 
